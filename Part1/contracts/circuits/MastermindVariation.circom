...
template MastermindVariation() {
   ...
   // Public inputs
    ...
    // create constraint of all 4 digits sum is equal to clue 
    //by code maker and present it to codebreaker
    clueByCmaker <== privSolnA+privSolnB+privSolnC+privSolnD;
